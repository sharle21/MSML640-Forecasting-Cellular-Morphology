...
def get_backbone():
    ...
    # Fixing pos_embed size (257 tokens -> 256 size)
...
def main():
    ...
    # evaluating whichpixels caused the magnitude of the movement
    ...
    # 3. Overlay
    # resizing raw to match saliency shape after transform
